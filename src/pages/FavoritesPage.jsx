 ...
 *
 * Displays a user's favorite movies and TV series.
 * Users can filter the list by type ('all', 'movies', 'tv') and remove items from favorites.
 *
 * Features:
 * - Filter favorites by type
 * - Display favorite movies and TV shows in a responsive grid
